...
if(block.currentTime==0)  %First iteration
    ...
    cube  = fill3(X,Y,Z,C,'Tag','cube');
    
    xaxis = fill3(Xxaxis,Yxaxis,Zxaxis,'r','Tag','xaxis');
    yaxis = fill3(Xyaxis,Yyaxis,Zyaxis,'r','Tag','yaxis');
    zaxis = fill3(Xzaxis,Yzaxis,Zzaxis,'r','Tag','zaxis');
    
    Ox=scatter3(Xxaxis(2),Yxaxis(2),Zxaxis(2),'filled','MarkerEdgeColor','k','MarkerFaceColor',xColor,'Tag','Ox');
    Oy=scatter3(Xyaxis(2),Yyaxis(2),Zyaxis(2),'filled','MarkerEdgeColor','k','MarkerFaceColor',yColor,'Tag','Oy');
    Oz=scatter3(Xzaxis(2),Yzaxis(2),Zzaxis(2),'filled','MarkerEdgeColor','k','MarkerFaceColor',zColor,'Tag','Oz');
